# Cal Poly SLO
# Saige Sloan
# Description: The following program will take in input from the given INPUT port every
#              every time there is an interrupt. It utilizes a flag to know when an interrupt
#              has been taken. While set the program will take input, isolating the least
#              significant nibble, which is added to an accumulator. Once 16 inputs have been
#              read in this manner, the average will be taken, and output to the LEDs.
...
ISR:
    addi  sp, sp, -4
    sw    t0, 0(sp) # Technically still good practice even though
